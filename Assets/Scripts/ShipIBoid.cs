...
public class ShipIBoid : MonoBehaviour
{
    List<ShipISteeringBehaviour> behaviours = new List<ShipISteeringBehaviour>();
    ...
    void Start()
    {
        ...
        ShipISteeringBehaviour[] behaviours = GetComponents<ShipISteeringBehaviour>();

        foreach (ShipISteeringBehaviour b in behaviours)
        {
